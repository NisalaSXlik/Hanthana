                ...
                <div class="middle-feed">
                    <div class="discover-header">
                        ...
                        <div class="search-bar">
                            ...
                            <input type="search" id="discoverSearchInput" placeholder="Search posts or groups..." aria-label="Search discover posts">
                        </div>
                        </form>
                    </div>
                    ...
                    <div class="discover-grid">
                        <?php if (!empty($allPosts)): ?>
                            <?php foreach (array_slice($allPosts, 0, 12) as $post): ?>  
                                <a
                                    href="<?php echo BASE_PATH; ?>index.php?controller=Discover&action=feed&post_id=<?php echo $post['post_id']; ?>"
                                    class="discover-item"
                                    data-search="<?php echo htmlspecialchars(strtolower(trim(($post['content'] ?? '') . ' ' . ($post['group_name'] ?? '')))); ?>"
                                >
