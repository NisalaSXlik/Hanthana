						...
						<?php foreach ($posts as $post): ?>
							<?php
								...
								$avatarUrl = !empty($post['profile_picture']) 
									...
									: BASE_PATH . '/public/images/avatars/defaultProfilePic.png';
							...
							<div class="feed" data-post-id="<?php echo (int)$post['post_id']; ?>" data-post-content="<?php echo $postContentForAttr; ?>">
								...
								<div class="action-buttons">
									<div class="interaction-buttons">
										...
										?>
										<i class="uil uil-arrow-up <?php echo $upClass; ?>" data-vote-type="upvote"></i><small><?php echo (int)($post['upvote_count'] ?? 0); ?></small>
										<i class="uil uil-arrow-down <?php echo $downClass; ?>" data-vote-type="downvote"></i><small><?php echo (int)($post['downvote_count'] ?? 0); ?></small>
									...
									<div class="add-comment-form">
										<div class="comment-input-container">
											...
											if (!empty($currentUserAvatar) && !filter_var($currentUserAvatar, FILTER_VALIDATE_URL)) {
												...
												$currentUserAvatar = '../../public/images/avatars/defaultProfilePic.png';
											}
											?>
