		...
		<div class="container">
			...
			<div class="feed" data-post-id="<?php echo (int)$post['post_id']; ?>" data-post-content="<?php echo $postContentForAttr; ?>" data-navigate-url="<?php echo htmlspecialchars($postUrl, ENT_QUOTES); ?>" style="cursor: pointer;">
								<div class="head">
									...
									<?php if ($isOwner): ?>
										<div class="post-menu">
											<button class="menu-trigger" aria-label="Post menu" onclick="event.stopPropagation();"><i class="uil uil-ellipsis-h"></i></button>
											<div class="menu">
												<button class="menu-item edit-post" data-post-id="<?php echo (int)$post['post_id']; ?>" onclick="event.stopPropagation();">
													<i class="uil uil-edit"></i> Edit
												</button>
												<button class="menu-item delete-post" data-post-id="<?php echo (int)$post['post_id']; ?>" onclick="event.stopPropagation();">
